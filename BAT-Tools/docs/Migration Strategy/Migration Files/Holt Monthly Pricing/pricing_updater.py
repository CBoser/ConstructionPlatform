#!/usr/bin/env python3
"""
UNCONVERTED PRICING UPDATER
Specifically configured for: Unconverted_Pricing_Update_File.xlsm
...
class HoltHomesUpdater:
    def __init__(self, file_path):
        """Initialize with Unconverted Pricing Updater File file"""
    ...
    def run_update(self):
        """Main update process"""
        print("\n" + "="*70)
        print("UNCONVERTED PRICING UPDATER")
        print("="*70)
...
def main():
    # Default Unconverted Pricing file path - UPDATED TO LOCAL PATH
    default_path = r"C:\Users\corey.boser\Documents\Holt Monthly Pricing\Unconverted_Pricing_Update_File.xlsm"
    ...
    if not os.path.exists(file_path):
        ...
        print("python pricing_updater.py 'path\\to\\your\\file.xlsm'")
        sys.exit(1)
    
    # Run updater
    updater = UnconvertedPricingUpdater(file_path)
